<?php
    ...
    if(!isset($_POST['password']) || empty($_POST['password']) || !isset($_POST['confirmpassword']) || empty($_POST['confirmpassword']) || !isset($_POST['email']) || empty($_POST['email']) || !isset($_POST['nickname']) || empty($_POST['nickname']) || !isset($_POST['firstname']) || empty($_POST['firstname']) || !isset($_POST['lastname']) || empty($_POST['lastname'])){
